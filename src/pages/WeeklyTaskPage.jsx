...
// Compresses images client-side to <800KB base64 — stored in Firestore
  ...
  if (!task) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-dark-bg flex flex-col items-center justify-center gap-4">
        ...
        <Link to="/problem" className="text-sm text-green-primary hover:underline">← Back to Challenges</Link>
      </div>
    );
  }
  ...
  if (alreadyDone && !submitted) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-dark-bg flex flex-col items-center justify-center gap-4 px-4">
        ...
        <Link to="/problem" className="text-sm text-green-primary hover:underline mt-2">← Back to Challenges</Link>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-dark-bg flex flex-col items-center justify-center gap-4 px-4">
        <div className="relative">
          ...
          <div className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-emerald-400 flex items-center justify-center text-white text-[10px] font-bold">✓</div>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg">
      ...
      <header className="sticky top-0 z-30 bg-white/80 dark:bg-dark-surface/80 backdrop-blur-md border-b border-gray-200 dark:border-dark-border">
        <div className="max-w-2xl mx-auto flex items-center gap-3 px-4 h-14">
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            <span className="text-lg">{SDG_ICONS[task.sdgGoal] ?? "🌱"}</span>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-emerald-400/60 uppercase tracking-wider font-medium">
                {task.type === "photo" ? "📸 Photo Submission" : "✍️ Written Reflection"} · Week {task.weekNumber}
              </p>
            </div>
          </div>
        ...
        <div className="rounded-xl bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border p-5">
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">📋 Your Task</h3>
              ...
              >
                {compressing ? (
                  <>
                    ...
                    <span className="text-xs text-emerald-400">Compressing…</span>
                  </>
                ) : (
                  <>
        ...
        <div className="rounded-xl bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border p-5 space-y-3">
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white flex items-center gap-2">
            ✍️ Your {isPhoto ? "Description" : "Reflection"}
          </h3>
          <textarea
            value={response}
        ...
        <div className="text-center pb-6">
          <p className="text-[11px] text-gray-400 dark:text-dark-muted">
            {isPhoto
              ? "📸 Photo submissions are voted on by the community in the feed"
              : "✅ Reflections are auto-approved and CLB is credited instantly"
            }
          </p>
        </div>
      </div>
