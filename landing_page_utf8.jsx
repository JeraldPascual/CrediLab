...
export default function LandingPage() {
  ...
  /* ΓöÇΓöÇ Parallax: hero fades / scales as user scrolls into features ΓöÇΓöÇ */
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-dark-bg">
      ...
      {/* ΓöÇΓöÇ Hero Section (parallax: fades + scales on scroll) ΓöÇΓöÇ */}
      <motion.div
        ref={heroRef}
      ...
      <section className="relative z-10 bg-slate-50 dark:bg-dark-bg">
        <div className="max-w-7xl mx-auto px-8 md:px-16 py-20">
              ...
              content={[
                {
                  ...
                  description:
                    "Curated problems across Easy, Medium, and Hard tiers ΓÇö auto-assessed in real-time using Judge0. Write, submit, and get instant feedback in a professional code editor.",
                  content: (
                  ...
                  content: (
                    <div className="h-full w-full flex items-center justify-center text-white p-6">
                      <div className="text-center space-y-2">
                        ...
                        <p className="text-sm opacity-80">Bronze ΓåÆ Diamond</p>
                      </div>
                    </div>
                  ),
                },
                ...
                },
                {
                  ...
                  description:
                    "Focus-loss detection and copy-paste tracking ensure every token earned is legitimate. No shortcuts ΓÇö your credentials mean something.",
                  content: (
                    <div className="h-full w-full flex items-center justify-center text-white p-6">
                      <div className="text-center space-y-2">
          ...
          <div className="md:hidden grid gap-6">
            <FeatureCard title="Java Challenges" description="40 curated problems across Easy, Medium, and Hard tiers ΓÇö auto-assessed in real-time using Judge0." icon={CodeBracketIcon} />
            ...
            <FeatureCard title="Anti-Cheat Verified" description="Focus-loss detection and copy-paste tracking ensure every token earned is legitimate. No shortcuts ΓÇö your credentials mean something." icon={ShieldCheckIcon} />
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-16 py-20">
          <div className="text-center mb-12">
            ...
            <p className="mt-3 text-gray-500 dark:text-dark-muted max-w-lg mx-auto">
              From sign-up to earning tokens ΓÇö it's simple, transparent, and decentralized.
            </p>
          </div>
      ...
      {/* ΓöÇΓöÇ Multi-Platform ΓöÇΓöÇ */}
      <section className="bg-slate-50 dark:bg-dark-bg">
        <div className="max-w-7xl mx-auto px-8 md:px-16 py-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            {/* Left ΓÇö text + platform list */}
            <div>
              ...
              <div className="space-y-5">
                {[
                  ...
                  { icon: DevicePhoneMobileIcon, title: "Mobile App (Android)", desc: "Built with Kotlin ΓÇö manage your wallet, submit weekly SDG tasks with photos, and track CLB on the go." },
                  { icon: GlobeAltIcon, title: "Shared Blockchain Layer", desc: "Both platforms connect to the same Sepolia smart contract ΓÇö your CLB balance syncs everywhere." },
                ].map((item) => (
      ...
      <section className="bg-white dark:bg-dark-surface">
        <div className="max-w-7xl mx-auto px-8 md:px-16 py-20 text-center">
          ...
          <p className="text-gray-500 dark:text-dark-muted max-w-2xl mx-auto mb-10">
            ...
            real-world action ΓÇö from tree planting to community clean-ups ΓÇö validated by
            peer voting and rewarded with CLB tokens.
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto">
            {[
              { icon: "≡ƒî│", label: "SDG 15", desc: "Life on Land", accent: "border-green-400" },
              { icon: "≡ƒÄô", label: "SDG 4", desc: "Quality Education", accent: "border-purple-400" },
              { icon: "≡ƒÆí", label: "SDG 9", desc: "Innovation", accent: "border-yellow-400" },
              { icon: "≡ƒñ¥", label: "SDG 17", desc: "Partnerships", accent: "border-orange-400" },
            ].map((sdg) => (
      ...
      <footer className="bg-white dark:bg-dark-surface px-8 md:px-16 py-8 text-center text-sm text-gray-400 dark:text-dark-muted">
        ┬⌐ {new Date().getFullYear()} CrediLab ΓÇö BulSU Hackathon Project
      </footer>
    </div>
  );
}

/* ΓöÇΓöÇ Hero with spotlight + grid background ΓöÇΓöÇ */
function HeroSpotlight() {
  ...
  return (
    ...
    >
      ...
      {/* Grid pattern ΓÇö light mode (with bottom fade) */}
      <div
      ...
      />
      {/* Grid pattern ΓÇö dark mode (with bottom fade) */}
      <div
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-8 md:px-16 py-12 md:py-16 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-7">
          ...
          <p className="text-lg text-gray-600 dark:text-dark-muted max-w-lg">
            ...
            build real-world programming skills ΓÇö bridging education with
            Web3 technology.
          </p>
...
/* ΓöÇΓöÇ Feature Card (mobile fallback) ΓöÇΓöÇ */
