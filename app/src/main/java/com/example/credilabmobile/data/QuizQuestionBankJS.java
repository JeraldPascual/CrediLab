...
public class QuizQuestionBankJS {
        ...
        private static void addEasy(List<QuizQuestion> l) {
                l.add(q(1, "What is the output?\nconsole.log(typeof 42);", "number", "integer", "int", "float", 0));
                ...
                l.add(q(18, "How do you write an arrow function?", "const f = () => {}", "function f() =>", "def f():",
                                "fn f() {}", 0));
                l.add(q(19, "What does this print?\nconsole.log(3 + 4 + '5');", "75", "345", "12", "Error", 0));
                ...
                l.add(q(25, "What is the output?\nlet s = 'hello';\nconsole.log(s.toUpperCase());", "HELLO", "hello",
                                "Hello", "Error", 0));
                ...
                l.add(q(33, "What is the output?\nlet x = 10;\nconsole.log(x > 5 ? 'big' : 'small');", "big", "small",
                                "Error", "undefined", 0));
                ...
                l.add(q(38, "How do you get the current date?", "new Date()", "Date.now()", "Date.current()",
                                "getDate()", 0));
                l.add(q(39, "What does this print?\nconsole.log(Boolean(''));", "false", "true", "Error", "undefined",
                                0));
                ...
                l.add(q(49, "What is the output?\nconsole.log([1,2,3].filter(n => n > 1));", "[2, 3]", "[1]",
                                "[1, 2, 3]", "Error", 0));
        ...
        private static void addMedium(List<QuizQuestion> l) {
                l.add(q(1, "What is the output?\nconsole.log([] == false);", "true", "false", "Error", "undefined", 0));
                ...
                l.add(q(5, "What is the output?\nconsole.log(foo);\nvar foo = 'bar';", "undefined", "bar", "Error",
                                "null", 0));
                ...
                l.add(q(13, "What is the output?\nconsole.log(0.1 + 0.2 === 0.3);", "false", "true", "Error", "NaN",
                                0));
                ...
                l.add(q(18, "What does the nullish coalescing operator ?? do?",
                                ...
                                "Type check", 0));
                l.add(q(19, "What does this print?\nlet x = null;\nconsole.log(x ?? 'default');", "default", "null",
                                "undefined", "Error", 0));
                ...
                l.add(q(37, "What is the output?\nconsole.log([...'hello']);", "['h','e','l','l','o']", "['hello']",
                                "Error", "undefined", 0));
                ...
                l.add(q(49, "What is the output?\nconsole.log([1,2,3].every(n => n > 0));", "true", "false", "Error",
                                "undefined", 0));
        ...
        private static void addHard(List<QuizQuestion> l) {
                l.add(q(1, "What is the output?\nconsole.log([] + []);", "'' (empty string)", "[]", "0", "Error", 0));
                ...
                l.add(q(5, "What does this print?\nconsole.log(typeof NaN);", "number", "NaN", "undefined", "Error",
                                0));
                ...
                l.add(q(11, "What is the output?\nconsole.log(+'');", "0", "NaN", "undefined", "Error", 0));
                ...
                l.add(q(43, "What is the output?\nconsole.log(typeof typeof 1);", "string", "number", "object", "Error",
                                0));
